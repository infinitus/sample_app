...
describe UsersController do
  ...
  describe "GET 'index'" do
    ...
    describe "for signed-in users" do
      ...
      it "should not contain delete links" do
        get :index
    ...
    describe "for admin users" do
      ...
      it "should contain delete links" do
        get :index
  ...
  describe "GET 'show'" do
    ...
    it "show the user's microposts" do
    ...
    it "should paginate the user's microposts" do
      test_sign_in(@user)
      50.times do
        Factory(:micropost, :user => @user, :content => "This is a test micropost")
      end
      get :show, :id => @user
      response.should have_selector("div.pagination")
      response.should have_selector("span.disabled", :content => "Previous")
